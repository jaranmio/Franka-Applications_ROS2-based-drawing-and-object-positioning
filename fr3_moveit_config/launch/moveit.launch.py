...
def generate_launch_description():
    ...
    # I (leo) added this for moveit task constructor
    ...
    ros2_control_node = Node(
        ...
        remappings=[("/controller_manager/robot_description", "/robot_description")], # removed the mapping ('joint_states', 'franka/joint_states'); added the mapping ("/controller_manager/robot_description", "/robot_description")
        output={
            'stdout': 'screen',
            'stderr': 'screen',
        },
    ...
    # Load controllers
    load_controllers = []
    for controller in ['fr3_arm_controller', 'joint_state_broadcaster', 'fr3_gripper']: # added fr3_gripper
        load_controllers += [
            ExecuteProcess(
    ...
    joint_state_publisher = Node(
        ...
        parameters=[
            # previous: source_list': ['franka/joint_states', 'fr3_gripper/joint_states'], 'rate': 30
            {'source_list': ['/joint_states'], 'rate': 60}
        ],
    )
